...
@WebMvcTest(SharePostController.class)
...
class SharePostControllerTest {
    ...
    void createSharePost() {
        SharePost sharePost = new SharePost(1L, "게시글1", "to share my post");
        SharePost sharePost1 = new SharePost(2L, "게시글2", "to share my post1");
    ...
    void getAllPosts() throws Exception {
        ...
        mockMvc.perform(get("/api/share-posts")
                ...
                .andExpect(jsonPath("$.content[0].title").value("게시글1"))
                .andExpect(jsonPath("$.content[1].title").value("게시글2"))
